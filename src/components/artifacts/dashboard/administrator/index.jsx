    ...
    <>
      ...
      <FixedMessageGroup>
        <Message negative header="Seja bem-vindo ao UProject">
          <p>Como administrator de projetos, você tem a capacidade de:</p>
          <ul>
            <li>Aprovar novos projetos.</li>
            <li>Aprovar trocas de rubricas.</li>
            <li>Acompanhar o andamento de todos os projetos.</li>
          </ul>
          <p>
